						...
						<div class="col-md-6 col-xs-12">
							<div class="row">
								<div class="test col-md-6 col-xs-6 col-sm-6">
									<a href="#">
										<div class="boxImg boxPadLeft">
											<img src="images/img2.jpg" class="boxImgHeight">
										</div>
										<div class="boxDesc2">
											<div class="row" style="margin:10px;">
								...
								<div class=" test col-md-6 col-xs-6 col-sm-6">
									<a href="#">
										<div class="boxImg ">
											<img src="images/img3.jpg" class="boxImgHeight">
										</div>
										<div class="boxDesc2">
											<div class="row" style="margin:10px;">
												<button>TECH</button>		
							...
							<div class="row">
								<div class="test col-md-6 col-xs-6 col-sm-6">
									<a href="#">
										<div class="boxImg boxPadLeft">
											<img src="images/img4.jpg" class="boxImgHeight">
										</div>
										<div class="boxDesc2">
											<div class="row" style="margin:10px;">
												<button>ARTS</button>		
								...
								<div class="test col-md-6 col-xs-6 col-sm-6">
									<a href="#">
										<div class="boxImg">
											<img src="images/img5.jpg" class="boxImgHeight">
										</div>
										<div class="boxDesc2">
											<div class="row" style="margin:10px;">
